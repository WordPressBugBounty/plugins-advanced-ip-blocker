...
{
    public const OPTION_METRICS = 'advaipbl_advanced_rules_metrics';
    public const TRANSIENT_BUFFER = 'advaipbl_rules_buffer';
    public const CRON_HOOK = 'advaipbl_aggregate_rules_metrics';
