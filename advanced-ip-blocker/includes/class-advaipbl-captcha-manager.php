    ...
    public function serve_challenge($challenge_type, $engine, $challenge_mode = 'managed')
    {
        ...
        <head>
            ...
            <style>
                ...
                .footer-brand a { color: #95a5a6; text-decoration: underline; margin-left: 4px; }
        ...
        <body>
            <div class="container">
                ...
                <div class="footer-brand">
                    <?php echo esc_html__('Performance &amp; security by', 'advanced-ip-blocker'); ?> <a rel="noopener noreferrer" href="https://advaipbl.com/" target="_blank">Advanced IP Blocker</a>
                </div>
            </div>
